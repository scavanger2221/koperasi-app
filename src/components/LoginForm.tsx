...
export function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center px-5 min-h-screen bg-[var(--color-bg-soft)]">
      <div className="w-full max-w-sm card p-8 md:p-10 border-[var(--color-border)]">
        <div className="text-center mb-10">
           <div className="inline-flex p-4 rounded-xl bg-white border border-[var(--color-border)] mb-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <div>
            <label htmlFor="password" title="Password wajib diisi" className="text-xs">
          ...
          <button 
            type="submit" 
            disabled={loading} 
            className="btn btn-primary w-full mt-4 text-sm font-extrabold uppercase tracking-widest h-12"
          >
            {loading ? (
        ...
        <div className="mt-10 text-center text-xs text-[var(--color-text-soft)] bg-[var(--color-bg-soft)] p-5 rounded-xl border border-[var(--color-border)]">
